...
module.exports = (port, host, argv) => Promise.resolve()
    ...
    .then(function () { return Promise.resolve(require('@codeanywhere/theia-ca-about-us/lib/node/backend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@codeanywhere/theia-ports/lib/node/backend-module')).then(load) })
    ...
    .then(function () { return Promise.resolve(require('@codeanywhere/theia-shareit/lib/node/backend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@codeanywhere/theia-workspace-keep-alive/lib/node/backend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@codeanywhere/theia-ca-base-config/lib/node/backend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@theia/mini-browser/lib/node/mini-browser-backend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@codeanywhere/theia-init-file-open/lib/node/backend-module')).then(load) })
